...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-[#4A7C59] via-[#EBF3EB] to-[#2C5E43] relative overflow-hidden">
      ...
      <DashboardSidebar />
      <div className="lg:pl-[18rem] flex flex-col min-h-screen relative z-10">
        <DashboardHeader />
        <main className="flex-grow p-6 max-w-[90rem] w-full mx-auto overflow-hidden">
